...
const hiddenOptions = ['g4f.Provider.Llama2', 'g4f.Provider.PerplexityLab', 'g4f.Provider.Bing', 'g4f.Provider.Liaobots', 'g4f.Provider.ChatgptLogin', 'g4f.Provider.Phind'];
  
  if (selectedModel === 'gpt-3.5-turbo') {
    providerSelect.value = 'g4f.Provider.Auto';
    hideOptions(hiddenOptions.filter(option => ['g4f.Provider.ChatgptLogin'].indexOf(option) === -1));
  } else if (selectedModel === 'gpt-4') {
    providerSelect.value = 'g4f.Provider.Auto';
    hideOptions(hiddenOptions.filter(option => ['g4f.Provider.Bing', 'g4f.Provider.Liaobots', 'g4f.Provider.Phind'].indexOf(option) === -1));
